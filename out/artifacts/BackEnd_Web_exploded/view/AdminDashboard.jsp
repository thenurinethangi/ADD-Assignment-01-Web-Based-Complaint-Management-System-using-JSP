...
<head>
    ...
    %>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/employee-dashboard-page-style.css?v=<%=timestamp%>">
</head>
<body>
...
<div class="dashboard-container">
    ...
    <nav class="sidebar employee-view">
        ...
        <div class="nav-menu">
            <a href="http://localhost:8080/BackEnd_Web_exploded/api/v1/page/dashboardadmin" class="nav-item active">
                <span class="nav-icon">🏠</span>
                Dashboard
            </a>
            <a href="http://localhost:8080/BackEnd_Web_exploded/api/v1/page/complaintsadmin" class="nav-item">
                <span class="nav-icon">📝</span>
                Complaints
            </a>
    ...
    <main class="main-content employee-view" style="background-color: #FFFFFF">
        <div class="header">
            ...
            <form id="logOut" action="http://localhost:8080/BackEnd_Web_exploded/api/v1/logout" method="post">

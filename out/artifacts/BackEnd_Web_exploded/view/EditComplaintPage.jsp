...
<head>
    ...
    %>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/edit-complaint-page-style.css?v=<%=timestamp%>">
    <style>
        #edit-btn{
            width: 100px;
        }
...
<script>
    //search bar
    let searchBarForm1 = $('#search-bar-form')[0];
    searchBarForm1.addEventListener('submit',function (event) {

...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/landing-page-style.css">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/assets/js/landing-page-script.js"></script>
</body>
</html>

...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/sign-up-page-style.css">
</head>
<body>
    ...
    <div id="content-container">
        <div id="input-fields-side">
            ...
            <div class="mb-3 sign-up-page-text">
                <h4>Create A New Account Today</h4>
                <p>Sign up now and easily manage complains with ResolveIT</p>
            </div>
            <form action="http://localhost:8080/BackEnd_Web_exploded/signup" method="post" id="sign-up-form">
                <div class="mb-3 input-fields">
                    <i class="fa-solid fa-envelope"></i>
                    <input type="email" class="form-control" id="enter-email" placeholder="Email" name="email">
                </div>
                <div class="mb-3 input-fields">
                    <i class="fa-solid fa-lock"></i>
                    <input type="password" class="form-control" id="enter-password" placeholder="Password" name="password">
                </div>
                <div class="mb-3">
                    <select class="form-select" aria-label="Default select example" id="role-input" name="role">
                        <option selected class="role-options" value="default">Select Your Role</option>
                        <option value="admin" class="role-options">Administrative</option>
                        <option value="employee" class="role-options">Employee</option>
                    </select>
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
                <p id="sign-in-phrase">Already have and account?&nbsp;<span><a href="${pageContext.request.contextPath}/view/SignInPage.jsp">Sign In</a></span></p>
            </div>
...
<script src="${pageContext.request.contextPath}/assets/js/signup-page-script.js"></script>
...
<script>
    $(document).ready(function() {
        document.getElementById("sign-up-form").addEventListener("submit", function (e) {
            ...
            let email = $('#enter-email').val().trim();
            let password = $('#enter-password').val().trim();
            ...
            if(!emailValidation || !passwordValidation){
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Invalid Input - Email must be valid format and password must be at least 7 characters',
                    icon: 'error',
                    confirmButtonText: 'Ok'
                });
                return;

...
<html>
<head>
    <title>EMS-View Complaints</title>
    ...
    %>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/style/view-complaint-page-style.css?v=<%=timestamp%>">
</head>
<body>
    ...
    <div class="row" id="main-row">
        <div class="col-3 col-lg-2" id="navigation-side">
            ...
            <div class="nav-menu">
                ...
                <a href="http://localhost:8080/BackEnd_Web_exploded/api/v1/page/viewComplaint" class="nav-item active">
                    <span class="nav-icon">🔍</span>
                    View Complaints
                </a>
                ...
                <table class="modern-table">
                    ...
                    <c:forEach var="x" items="${sessionScope.complaintsList}">
                        ...
                        <tr>
                            ...
                            <td>
                                <form class="action-buttons" action="http://localhost:8080/BackEnd_Web_exploded/api/v1/complaint/delete" method="post">
